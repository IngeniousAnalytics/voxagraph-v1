...
Get project tree
npx tree-cli -a -l 3 -I "node_modules,.git,dist,build,.next,.turbo,.nx,coverage,.vscode,.idea"
...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/puwlVuwv3P)
...
```sh
npx nx show project ai-dashboard
```
